...
% Eingabe
anzahl_rotwein = input('Anzahl Rotweinflaschen: ')
anzahl_rosewein = input('Anzahl Roseweinflaschen: ')
anzahl_weisswein = input('Anzahl Weissweinflaschen: ')
...
% Ausgabe
fprintf('Die Gesamtkosten sind %f Euro.', gesamt_kosten)